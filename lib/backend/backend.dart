...
import 'schema/arduinos_record.dart';
...
export 'schema/arduinos_record.dart';
...
/// Functions to query ArduinosRecords (as a Stream and as a Future).
Future<int> queryArduinosRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      ArduinosRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<ArduinosRecord>> queryArduinosRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<List<ArduinosRecord>> queryArduinosRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<ArduinosRecord>> queryArduinosRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
