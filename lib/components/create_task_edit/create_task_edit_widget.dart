...
class _CreateTaskEditWidgetState extends State<CreateTaskEditWidget> {
  ...
  void initState() {
    ...
    _model.textController1 ??=
        TextEditingController(text: widget.todoRef!.temperatura?.toString());
    _model.textController2 ??=
        TextEditingController(text: widget.todoRef!.humidade?.toString());
