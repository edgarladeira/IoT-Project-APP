...
class AppStateNotifier extends ChangeNotifier {
  EstufaInteligenteFirebaseUser? initialUser;
  EstufaInteligenteFirebaseUser? user;
  ...
  void update(EstufaInteligenteFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ...
              : MyTasksWidget(
                  arduinos: params.getParam('arduinos', ParamType.String),
                ),
        ),
        FFRoute(
          name: 'Register',
